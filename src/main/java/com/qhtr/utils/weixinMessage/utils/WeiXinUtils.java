...
public class WeiXinUtils {
		...
		public static String getOpenId(String code){
			...
			String replace = url.replace("APPID", Constants.WEIXINPUBLIC_APPID).replace("SECRET", Constants.WEIXINPUBLIC_APPSECRET).replace("CODE", code);
			// 发送请求
	    ...
	    public static void send_template_message(String appId, String appSecret,WxTemplate temp) {
	    	...
	    	// String access_token = "2xLmHkRwH4SNxxvIF3iDwxsksJEGOAhCKixCx0D8gEJuiDY4lG-3rhCBM2rX6VW-ZhCPKtfxmBv71xuLbD9_8GbwvCBD46kFuCSBN-metIzBH1O6UtcE4AwmwSJO3VnRWEPdAHAMUF";
